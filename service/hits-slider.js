...
import { addClickBtnBuy } from "./cartBtnService.js"

function renderHitsSlider(allProducts, sliderWrapper) {
    ...
    allProducts.forEach(product => {
        ...
        if (product.comments.length > 0) {
            ...
            totalRate = Math.round(summRate / product.comments.length)
                            ...
                            <div class="swiper-slide">
                                <div class="product-card">
                                    ...
                                    <div class="product-card__content">
                                        ...
                                        <a href="/pages/product.html?id=${product.id} " class="product-card__reviews">
    ...
    addClickBtnBuy(sliderWrapper, allProducts)

}

export { renderHitsSlider }